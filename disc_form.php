...
<?php include("header.php"); ?>
    ...
    <div class="container form-group">
        <a href="discs.php?id=<?= $myDisc->disc_id ?>" class="btn btn-primary">Retour</a><br>
        <br>
        ...
        <form action ="script_disc_modif.php" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="title_modif" class="form-control" id="disc_titre_modif" value="<?= $myDisc->disc_title ?>">
            <br><br>

            <label for="nom_artiste_modif">Artist</label><br>        
            <select id="nom_artiste_modif" name="artist_id_modif" class="form-control"> 
            ...
            <input type="text" name="year_modif" id="disc_year_modif" class="form-control" value="<?= $myDisc->disc_year ?>">
            <br><br>

            <label for="disc_genre_modif">Genre</label><br>
            <input type="text" name="genre_modif" id="disc_genre_modif" class="form-control" value="<?= $myDisc->disc_genre ?>">
            <br><br>

            <label for="disc_label_modif">Label</label><br>
            <input type="text" name="label_modif" id="disc_label_modif" class="form-control" value="<?= $myDisc->disc_label ?>">
            <br><br>

            <label for="disc_price_modif">Price</label><br>
            <input type="text" name="price_modif" id="disc_price_modif" class="form-control" value="<?= $myDisc->disc_price ?>">
            <br><br>

            <label for="disc_picture_modif">Picture</label><br>
            <input type="file" name="img_modif" id="disc_picture_modif" class="form-control"><br>
